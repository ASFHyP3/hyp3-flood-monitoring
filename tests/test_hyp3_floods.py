...
def test_is_valid_hazard_start_date():
    assert hyp3_floods.is_valid_hazard(
        {'type_ID': 'FLOOD', 'category_ID': 'EVENT', 'severity_ID': 'WARNING', 'start_Date': 1},
        current_time_in_ms=2
    ) is True

    assert hyp3_floods.is_valid_hazard(
        {'type_ID': 'FLOOD', 'category_ID': 'EVENT', 'severity_ID': 'WARNING', 'start_Date': 2},
        current_time_in_ms=2
    ) is True

    assert hyp3_floods.is_valid_hazard(
        {'type_ID': 'FLOOD', 'category_ID': 'EVENT', 'severity_ID': 'WARNING', 'start_Date': 3},
        current_time_in_ms=2
    ) is False
...
def test_is_valid_hazard_type():
    ...
    assert hyp3_floods.is_valid_hazard(
        {'type_ID': 'foo', 'category_ID': 'EVENT', 'severity_ID': 'WARNING', 'start_Date': 1},
        current_time_in_ms=2
    ) is False
...
def test_is_valid_hazard_category():
    ...
    assert hyp3_floods.is_valid_hazard(
        {'type_ID': 'FLOOD', 'category_ID': 'foo', 'severity_ID': 'WARNING', 'start_Date': 1},
        current_time_in_ms=2
    ) is False
...
def test_is_valid_hazard_severity():
    ...
    assert hyp3_floods.is_valid_hazard(
        {'type_ID': 'FLOOD', 'category_ID': 'EVENT', 'severity_ID': 'foo', 'start_Date': 1},
        current_time_in_ms=2
    ) is False
