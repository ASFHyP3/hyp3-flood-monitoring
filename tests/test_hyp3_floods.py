...
def test_lambda_handler(
    ...
    active_hazards = [
        {'uuid': '0', 'category_ID': 'EVENT', 'type_ID': 'FLOOD', 'start_Date': 1653658144630},
        {'uuid': '1', 'category_ID': 'EVENT', 'type_ID': 'foo', 'start_Date': 1653658144630},
        {'uuid': '2', 'category_ID': 'EVENT', 'type_ID': 'FLOOD', 'start_Date': 1653658144640},
        {'uuid': '3', 'category_ID': 'EVENT', 'type_ID': 'bar', 'start_Date': 1653658144640},
        {'uuid': '4', 'category_ID': 'EVENT', 'type_ID': 'FLOOD', 'start_Date': 1653658144650},
        {'uuid': '5', 'category_ID': 'EVENT', 'type_ID': 'baz', 'start_Date': 1653658144650},
    ]
...
def test_filter_hazards():
    hazards = [
        {'uuid': 0, 'category_ID': 'EVENT', 'type_ID': 'FLOOD', 'start_Date': 1},
        {'uuid': 1, 'category_ID': 'EVENT', 'type_ID': 'foo', 'start_Date': 1},
        {'uuid': 2, 'category_ID': 'EVENT', 'type_ID': 'FLOOD', 'start_Date': 2},
        {'uuid': 3, 'category_ID': 'EVENT', 'type_ID': 'bar', 'start_Date': 2},
        {'uuid': 4, 'category_ID': 'EVENT', 'type_ID': 'FLOOD', 'start_Date': 3},
        {'uuid': 5, 'category_ID': 'EVENT', 'type_ID': 'baz', 'start_Date': 3},
    ]
...
def test_is_valid_hazard_start_date():
    assert hyp3_floods.is_valid_hazard(
        {'type_ID': 'FLOOD', 'category_ID': 'EVENT', 'start_Date': 1},
        current_time_in_ms=2
    ) is True

    assert hyp3_floods.is_valid_hazard(
        {'type_ID': 'FLOOD', 'category_ID': 'EVENT', 'start_Date': 2},
        current_time_in_ms=2
    ) is True

    assert hyp3_floods.is_valid_hazard(
        {'type_ID': 'FLOOD', 'category_ID': 'EVENT', 'start_Date': 3},
        current_time_in_ms=2
    ) is False
...
def test_is_valid_hazard_type():
    ...
    assert hyp3_floods.is_valid_hazard(
        {'type_ID': 'foo', 'category_ID': 'EVENT', 'start_Date': 1},
        current_time_in_ms=2
    ) is False
...
def test_is_valid_hazard_category():
    ...
    assert hyp3_floods.is_valid_hazard(
        {'type_ID': 'FLOOD', 'category_ID': 'foo', 'start_Date': 1},
        current_time_in_ms=2
    ) is False
